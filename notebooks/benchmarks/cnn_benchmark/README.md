...
This is a useful CNN-v2 improvement, but the scores are still modest for promoter prediction. The next benchmark step should test stronger sequence models while reusing the same predefined split.
